    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (error.message.includes("HuggingFace")) {
          console.error("This is a HuggingFace API error. Please check your REDACTED_HUGGINGFACE_KEY and network connectivity.");
        } else if (error.message.includes("GEMINI")) {
          console.error("This is a Google Gemini API error. Please check your REDACTED_GEMINI_KEY and network connectivity.");
        }
      }
